// Лабораторная 6, задача 3. Выполнена: Киселёв А.В 153504

/*Стандартных функций работы со строками не
использовать.
8.Используя указатели, написать функции перевода целых чисел в
строку и строки в число; функции перевода вещественных чисел в строку,
перевода строки в вещественное число. Стандартных функций работы со
