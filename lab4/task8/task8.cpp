//Лабораторная 4, задача 8. Выполнена: Киселёв А.В 153504
...
int main() {
	...
	long double size;
	int max, min, nummax = 0, nummin = 0, start, stop, nul = 0;

	std::cout << "Данный код заменяет нулями все элементы, которые находятся в ячейках между минимальным и максимальным элементами,\nлибо удаляет их.\n\n";
