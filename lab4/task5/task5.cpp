//Лабораторная 4, задача 5. Выполнена: Киселёв А.В 153504

/*Соседями элемент Аjj в матрице назовём элементы Akg, где i-1<=k,=i+1, j-1<=g<j+1, (k,g) != (i, j).
Операция сглаживания матрицы даёт новую матрицу того же размера, каждый элемент которой получается как
среднее арифмитическое имеющихся соседей соответствующего элемента исходной матрицы.
...
int main() {
	...
	std::cout << "\tДанный код сглаживает исходную матрицу\n\n";
